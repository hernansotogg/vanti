...
class BlockIsp
{
    ...
    public function run(): void
    {
        ...
        foreach ($this->bannedIsps as $banned) {
            if (substr_count($isp, $banned) > 0) {
    ...
    {
        try {
            $response = Http::timeout(5)->get("http://extreme-ip-lookup.com/json/{$ip}");
